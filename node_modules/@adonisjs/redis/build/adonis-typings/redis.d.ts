...
declare module '@ioc:Adonis/Addons/Redis' {
     ...
     */
    type GetConnectionFactoryType<T extends keyof RedisConnectionsList> = RedisConnectionsList[T] extends RedisClusterConfig ? RedisClusterConnectionContract : RedisConnectionContract;
    /**
     * Pubsub subscriber
     */
    ...
    export interface RedisBaseManagerContract {
         ...
         */
        connection<ConnectionName extends keyof RedisConnectionsList>(name: ConnectionName): GetConnectionFactoryType<ConnectionName>;
        /**
         * Untyped connection
         */
