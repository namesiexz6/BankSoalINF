...
declare module '@ioc:Adonis/Addons/I18n' {
     ...
     */
    export type ValidatorWildcardCallback = (field: string, rule: string, arrayExpressionPointer?: string, args?: any) => string;
    /**
     ...
     */
    export type FormatterExtendCallback = (manager: I18nManagerContract, config: I18nConfig) => TranslationsFormatterContract;
    /**
     * I18n manager shape
     */
