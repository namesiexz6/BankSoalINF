...
exports.I18n = void 0;
const Core_1 = require("../Formatters/Core");
/**
 * I18n class works with a dedicated locale at a given point
 * in time
 */
class I18n extends Core_1.Formatter {
    constructor(locale, emitter, logger, i18nManager) {
        super(locale);
        this.locale = locale;
     ...
     */
    formatValidatorMessage(identifier, data, forceNotify = false) {
     ...
     * failure messages
     */
    validatorMessages(messagesPrefix = 'validator.shared') {
        return {
            '*': (field, rule, arrayExpressionPointer, options) => {
                ...
                if (arrayExpressionPointer) {
                    const arrayRuleMessage = this.formatValidatorMessage(`${messagesPrefix}.${arrayExpressionPointer}.${rule}`, data);
                    if (arrayRuleMessage) {
